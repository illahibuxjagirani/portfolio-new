  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-32 text-xl gap-24 md:gap-32 lg:-48 xl:64 flex flex-col">
          {/* Biography Starts */}
          ...
          <div className="flex flex-col gap-12 justify-center" ref={skillRef}>
            ...
            >
              <div className="bg-black p-2 text-white text-sm rounded cursor-pointer hover:bg-white hover:text-black font-bold">
                TypeScript
              </div>
          ...
          {/* Experience Starts */}
          <div
            className="flex flex-col gap-12 justify-center pb-4"
            ref={experienceRef}
          >
            <motion.h1
              initial={{ x: "-300px" }}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3">
                  ...
                  <div className="p-3 text-sm italic text-justify">
                    Lorem ipsum dolor sit amet conctetur isicing elit. Consecr
                    quia te!
                  </div>
                  ...
                  <div className="bg-white px-2 py-1 rounded text-sm font-semibold w-fit">
                    PIAIC
                  </div>
                </div>
                ...
                <div className="w-1/6 flex justify-center">
                  <div className="w-1 h-full bg-gray-600 rounded-full relative">
