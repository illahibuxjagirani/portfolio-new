...
function TransitionProvider({ children }) {
  ...
  const firstLetter = pathName.slice(1)
  const restLetter = firstLetter.charAt(0).toUpperCase() + firstLetter.slice(1);
  return (
    <AnimatePresence mode="wait">
      ...
      >
        <motion.div
          className="h-scrren w-screen fixed bg-black rounded-b-[100px] z-40"
          animate={{ height: "0vh" }}
          exit={{ height: "120vh" }}
        ...
        <motion.div
          className="h-scrren w-screen fixed bg-black rounded-t-[100px] bottom-0 z-30"
